...
router.get('/director/:director_id', async (req: Request, res: Response) => {
  let resp = null;
  try {
    resp = await api.get(req.path);
    res.send(resp.data);
...
router.put('/director/:director_id', async (req: Request, res: Response) => {
  let resp = null;
  try {
...
router.delete('/director/:director_id', async (req: Request, res: Response) => {
  let resp = null;
  try {
